...
interface DynamoDbClient : SdkClient {
     ...
     */
    suspend fun describeLimits(input: DescribeLimitsRequest = DescribeLimitsRequest {}): DescribeLimitsResponse
     ...
     */
    suspend fun listBackups(input: ListBackupsRequest = ListBackupsRequest {}): ListBackupsResponse
     ...
     */
    suspend fun listContributorInsights(input: ListContributorInsightsRequest = ListContributorInsightsRequest {}): ListContributorInsightsResponse
     ...
     * This operation only applies to [Version 2017.11.29](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/globaltables.V1.html) of global tables.
     */
    suspend fun listGlobalTables(input: ListGlobalTablesRequest = ListGlobalTablesRequest {}): ListGlobalTablesResponse
     ...
     */
    suspend fun listTables(input: ListTablesRequest = ListTablesRequest {}): ListTablesResponse
