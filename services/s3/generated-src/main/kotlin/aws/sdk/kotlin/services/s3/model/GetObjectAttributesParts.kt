 ...
 */
class GetObjectAttributesParts private constructor(builder: Builder) {
    /**
     ...
     */
    val parts: List<ObjectPart>? = builder.parts
    /**
     * The total number of parts.
     */
    val totalPartsCount: kotlin.Int = builder.totalPartsCount

    companion object {
        operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.s3.model.GetObjectAttributesParts = Builder().apply(block).build()
    }
    ...
    inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.s3.model.GetObjectAttributesParts = Builder(this).apply(block).build()
    ...
    class Builder {
         ...
         * A container for elements related to a particular part. A response can contain zero or more `Parts` elements.
         */
        var parts: List<ObjectPart>? = null
        /**
         * The total number of parts.
         */
        var totalPartsCount: kotlin.Int = 0
