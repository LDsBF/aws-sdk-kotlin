...
class ResponseLaunchTemplateData private constructor(builder: Builder) {
     ...
     */
    val maintenanceOptions: aws.sdk.kotlin.services.ec2.model.LaunchTemplateInstanceMaintenanceOptions? = builder.maintenanceOptions
    /**
    ...
    class Builder {
         ...
         * The maintenance options for your instance.
         */
        var maintenanceOptions: aws.sdk.kotlin.services.ec2.model.LaunchTemplateInstanceMaintenanceOptions? = null
        /**
         * The metadata options for the instance. For more information, see [Instance metadata and user data](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-instance-metadata.html) in the *Amazon Elastic Compute Cloud User Guide*.
         */
         ...
         */
        fun maintenanceOptions(block: aws.sdk.kotlin.services.ec2.model.LaunchTemplateInstanceMaintenanceOptions.Builder.() -> kotlin.Unit) {
