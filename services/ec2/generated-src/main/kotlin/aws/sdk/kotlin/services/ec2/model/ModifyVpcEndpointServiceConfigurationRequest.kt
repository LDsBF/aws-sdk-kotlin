...
class ModifyVpcEndpointServiceConfigurationRequest private constructor(builder: Builder) {
     ...
     */
    val addSupportedIpAddressTypes: List<String>? = builder.addSupportedIpAddressTypes
    /**
     ...
     */
    val removeSupportedIpAddressTypes: List<String>? = builder.removeSupportedIpAddressTypes
    /**
    ...
    class Builder {
         ...
         * The IP address types to add to your service configuration.
         */
        var addSupportedIpAddressTypes: List<String>? = null
        /**
         * Checks whether you have the required permissions for the action, without actually making the request, and provides an error response. If you have the required permissions, the error response is `DryRunOperation`. Otherwise, it is `UnauthorizedOperation`.
         */
         ...
         * The IP address types to remove from your service configuration.
         */
        var removeSupportedIpAddressTypes: List<String>? = null
        /**
         * The ID of the service.
         */
