...
class RunInstancesRequest private constructor(builder: Builder) {
     ...
     */
    val maintenanceOptions: aws.sdk.kotlin.services.ec2.model.InstanceMaintenanceOptionsRequest? = builder.maintenanceOptions
    /**
    ...
    class Builder {
         ...
         * The maintenance and recovery options for the instance.
         */
        var maintenanceOptions: aws.sdk.kotlin.services.ec2.model.InstanceMaintenanceOptionsRequest? = null
        /**
         * The maximum number of instances to launch. If you specify more instances than Amazon EC2 can launch in the target Availability Zone, Amazon EC2 launches the largest possible number of instances above `MinCount`.
         *
         * Constraints: Between 1 and the maximum number you're allowed for the specified instance type. For more information about the default limits, and how to request an increase, see [How many instances can I run in Amazon EC2](http://aws.amazon.com/ec2/faqs/#How_many_instances_can_I_run_in_Amazon_EC2) in the Amazon EC2 FAQ.
         ...
         */
        fun maintenanceOptions(block: aws.sdk.kotlin.services.ec2.model.InstanceMaintenanceOptionsRequest.Builder.() -> kotlin.Unit) {
