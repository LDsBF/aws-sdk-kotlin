...
class IpamResourceCidr private constructor(builder: Builder) {
    /**
     * The compliance status of the IPAM resource. For more information on compliance statuses, see [Monitor CIDR usage by resource](/vpc/latest/ipam/monitor-cidr-compliance-ipam.html) in the *Amazon VPC IPAM User Guide*.
     */
    ...
    /**
     * The management state of the resource. For more information about management states, see [Monitor CIDR usage by resource](/vpc/latest/ipam/monitor-cidr-compliance-ipam.html) in the *Amazon VPC IPAM User Guide*.
     */
    val managementState: aws.sdk.kotlin.services.ec2.model.IpamManagementState? = builder.managementState
    /**
     * The overlap status of an IPAM resource. The overlap status tells you if the CIDR for a resource overlaps with another CIDR in the scope. For more information on overlap statuses, see [Monitor CIDR usage by resource](/vpc/latest/ipam/monitor-cidr-compliance-ipam.html) in the *Amazon VPC IPAM User Guide*.
     */
