 ...
 */
class TransitGatewayRouteTableRoute private constructor(builder: Builder) {
    /**
     ...
     * + propagated
     */
    val routeOrigin: kotlin.String? = builder.routeOrigin
    /**
    ...
    companion object {
        operator fun invoke(block: Builder.() -> kotlin.Unit): aws.sdk.kotlin.services.ec2.model.TransitGatewayRouteTableRoute = Builder().apply(block).build()
    }
    ...
    inline fun copy(block: Builder.() -> kotlin.Unit = {}): aws.sdk.kotlin.services.ec2.model.TransitGatewayRouteTableRoute = Builder(this).apply(block).build()
    ...
    class Builder {
         ...
         * + propagated
         */
        var routeOrigin: kotlin.String? = null
        /**
         * The state of the route.
         */
