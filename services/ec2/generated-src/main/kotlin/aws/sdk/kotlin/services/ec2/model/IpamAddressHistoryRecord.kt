...
/**
 * The historical record of a CIDR within an IPAM scope. For more information, see [View the history of IP addresses](/vpc/latest/ipam/view-history-cidr-ipam.html) in the *Amazon VPC IPAM User Guide*.
 */
class IpamAddressHistoryRecord private constructor(builder: Builder) {
    ...
    /**
     * The compliance status of a resource. For more information on compliance statuses, see [Monitor CIDR usage by resource](/vpc/latest/ipam/monitor-cidr-compliance-ipam.html) in the *Amazon VPC IPAM User Guide*.
     */
