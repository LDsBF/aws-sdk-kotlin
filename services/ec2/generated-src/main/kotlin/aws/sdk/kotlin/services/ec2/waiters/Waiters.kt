...
suspend fun Ec2Client.waitUntilNatGatewayDeleted(request: DescribeNatGatewaysRequest): Outcome<DescribeNatGatewaysResponse> {
    val strategy = run {
        val delayOptions = ExponentialBackoffWithJitterOptions(
            initialDelay = 15_000.milliseconds,
            scaleFactor = 1.5,
...
suspend fun Ec2Client.waitUntilNatGatewayDeleted(block: DescribeNatGatewaysRequest.Builder.() -> Unit): Outcome<DescribeNatGatewaysResponse> =
